...
var firebaseConfig = {
  ...
  authDomain: "voldecade-ranking.firebaseapp.com",
  projectId: "voldecade-ranking",
  storageBucket: "voldecade-ranking.firebasestorage.app",
  messagingSenderId: "224863199504",
  appId: "1:224863199504:web:4b2f2977386a8b68844595"
};
...
onAuthStateChanged(auth, (user) => {
  activeUser = user;
  if (user === null) localStorage.removeItem(CACHE_KEY);
  resolveAuthReady?.();
...
var scoreOrder = (a, b) => b.clearedStages - a.clearedStages || (a.turnsToLastClear ?? Number.MAX_SAFE_INTEGER) - (b.turnsToLastClear ?? Number.MAX_SAFE_INTEGER) || b.killDifference - a.killDifference;
var errorText = (error) => {
  const code = error !== null && typeof error === "object" && "code" in error ? String(error.code) : "";
  if (code.includes("popup-blocked")) return "Google\u30ED\u30B0\u30A4\u30F3\u306E\u753B\u9762\u304C\u30D6\u30ED\u30C3\u30AF\u3055\u308C\u307E\u3057\u305F\u3002\u30DD\u30C3\u30D7\u30A2\u30C3\u30D7\u3092\u8A31\u53EF\u3057\u3066\u3001\u3082\u3046\u4E00\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002";
  if (code.includes("popup-closed-by-user")) return "Google\u30ED\u30B0\u30A4\u30F3\u3092\u30AD\u30E3\u30F3\u30BB\u30EB\u3057\u307E\u3057\u305F\u3002\u30ED\u30B0\u30A4\u30F3\u3059\u308B\u5834\u5408\u306F\u3001\u3082\u3046\u4E00\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002";
  if (code.includes("cancelled-popup-request")) return "Google\u30ED\u30B0\u30A4\u30F3\u753B\u9762\u3092\u6E96\u5099\u3057\u3066\u3044\u307E\u3059\u3002\u5C11\u3057\u5F85\u3063\u3066\u304B\u3089\u3082\u3046\u4E00\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002";
  if (code.includes("operation-not-allowed")) return "Firebase Authentication\u3067Google\u30ED\u30B0\u30A4\u30F3\u3092\u6709\u52B9\u306B\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
  if (code.includes("api-key-not-valid") || code.includes("invalid-api-key")) return "Firebase Web\u30A2\u30D7\u30EA\u306EAPI\u30AD\u30FC\u304C\u7121\u52B9\u3067\u3059\u3002Firebase\u30D7\u30ED\u30B8\u30A7\u30AF\u30C8\u8A2D\u5B9A\u306EWeb\u30A2\u30D7\u30EA\u69CB\u6210\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
  if (code.includes("internal-error")) return "Firebase\u306EGoogle\u30ED\u30B0\u30A4\u30F3\u51E6\u7406\u3067\u5185\u90E8\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002\u627F\u8A8D\u6E08\u307F\u30C9\u30E1\u30A4\u30F3\u3068Google\u30ED\u30B0\u30A4\u30F3\u306E\u8A2D\u5B9A\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
  ...
  if (code.includes("permission-denied")) return "Firestore\u306E\u30A2\u30AF\u30BB\u30B9\u8A2D\u5B9A\u304C\u672A\u5B8C\u4E86\u3067\u3059\u3002Firebase\u3078\u30BB\u30AD\u30E5\u30EA\u30C6\u30A3\u30EB\u30FC\u30EB\u3092\u516C\u958B\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
...
var readLeaderboard = async (season = "v1") => {
  try {
    const q2 = query(collection(db, "leaderboards", season, "entries"), orderBy("clearedStages", "desc"), orderBy("turnsToLastClear", "asc"), orderBy("killDifference", "desc"), limit(100));
